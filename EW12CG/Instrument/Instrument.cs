...
namespace EW12CG.Function {
    public abstract class Instrument {
        ...
        public abstract bool config_Instrument_Total(string port, int trigger_lever, string Standard);
        ...
        public abstract string config_Instrument_get_Power(string Trigger, int PowerRange, string wifi);
        ...
        protected static void saveLogfile(string pathfile, string content)// 
        {
            try {
